  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="rounded-full px-3 py-1.5 text-base text-[var(--jao-text-secondary)] transition-colors hover:bg-[var(--jao-border-subtle)] hover:text-[var(--jao-text)] focus:outline-none focus:ring-2 focus:ring-[var(--jao-primary)]/30"
      >
        History ▾
      </button>
      {open && (
